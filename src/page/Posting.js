...
//icon
import { BiHappyHeartEyes, BiSad, BiShocked, BiLaugh, BiMehAlt, BiMeh, BiCool } from "react-icons/bi"
        ...
        quillInstance.current = new Quill(quillElement.current, {
            ...
            modules: {
                toolbar: [
                    ...
                    ['link', 'image'],
                    [{ 'color': ['red', 'yellow', 'blue', 'white'] }, { 'background': ['black', 'white', 'pink', 'skyblue'] }],
                ],
            },
        });
    }, []);
        ...
        <>
            <div>
                <div className='dateWrite'>
                    <input type="text" className="input_date" value={year} onChange={onChangeYear} /><span className="span_date">년</span>
                    <input type="text" className="input_date" value={month} onChange={onChangeMonth} /><span className="span_date">월</span>
                    <input type="text" className="input_date" value={date} onChange={onChangeDate} /><span className="span_date">일</span>
...
function getDay(day) {
    ...
    let daylist = new Array('일요일', '월요일', '화요일', '수요일', '목요일', '금요일', '토요일')
